...
public class rec {
	...
	public rec(long sl_no, String business_code, long cust_number, String clear_date, long buisness_year, long doc_id,
			String posting_date, String document_create_date, String due_in_date, String invoice_currency,
			String document_type, long posting_id, double total_open_amount, String baseline_create_date,
			String cust_payment_terms, long invoice_id) {
		super();
		this.sl_no = sl_no;
	...
	public long getBuisness_year() {
		return buisness_year;
	}
	public void setBuisness_year(long buisness_year) {
		this.buisness_year = buisness_year;
	}
